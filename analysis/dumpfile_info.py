...
def main():
    ...
    with open(dump_filename, 'rb') as file_in:
        num_words = serial_analysis.file_seek_next_data_dump_and_count_it(file_in, binary_format)
        ...
        file_in.seek(0)
        serial_analysis.file_seek_next_data_dump_and_count_it(file_in, binary_format)
