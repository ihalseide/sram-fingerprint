...
file_path = r"C:\Users\afeig\Documents\school\Current_Semester\ECE-401\5_15_second_shutoff\Garbage_Values_130nm-_diff_manu\50_captures_15_second_delay.txt" 
...
# Normalize bit votes for display 
...
# Apply the 'Blues' colormap for a blue gradient 
plt.imshow(bit_votes_image_upscaled, cmap='Blues') 
 
# Add a color bar to indicate the intensity of the votes 
plt.colorbar(label='Bit vote count (normalized)') 
 
# Save and show the image 
plt.savefig("bit_votes_colormap_visualization_blue_upscaled.png", dpi=20) 
plt.show() 
