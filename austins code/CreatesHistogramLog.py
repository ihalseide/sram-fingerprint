...
path = r"C:\Users\afeig\Documents\school\Current_Semester\ECE-401\5_15_second_shutoff\CY-250nm-1-rad"
BITS_PER_WORD = 16
...
file_path = os.path.join(path, "RT-30s-20dumps.txt")  # Replace with your actual file name
...
plt.bar(bin_edges[:-1], hist, color='blue', edgecolor='black', width=0.7)
...
plt.title('Histogram first CY 90nm Radiation')
plt.xlabel('Number of Ones')
plt.ylabel('Log of Occurrences')
plt.grid(True)
